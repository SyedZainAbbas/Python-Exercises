**Object-oriented programming (OOP)** is a programming paradigm that provides a means of structuring programs so that properties and behaviors are bundled into individual
objects.
